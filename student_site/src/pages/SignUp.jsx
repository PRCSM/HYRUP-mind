...
function SignUp() {
    ...
    const cards = [
        {
            ...
            title: "Take quick tests. Get verified badges. Show employers what you can actually do.",
            author: "HYRUP Team",
            icon: (
                <svg viewBox="0 0 100 100" className="w-full h-full">
                    <rect x="15" y="35" width="50" height="35" rx="3" fill="none" stroke="black" strokeWidth="2"/>
                    <rect x="10" y="70" width="60" height="5" rx="2" fill="none" stroke="black" strokeWidth="2"/>
                    <path d="M30 45 Q40 35 50 45 Q60 55 70 45" fill="none" stroke="black" strokeWidth="2"/>
                    <path d="M25 50 Q35 40 45 50" fill="none" stroke="black" strokeWidth="2"/>
                </svg>
            )
        },
        {
            ...
            title: "Match with companies who care about talent, not where you studied. Zero bias.",
            author: "HYRUP Team",
            icon: (
                <svg viewBox="0 0 100 100" className="w-full h-full">
                    <rect x="20" y="20" width="15" height="50" rx="2" fill="none" stroke="black" strokeWidth="2" transform="rotate(-15 27 45)"/>
                    <line x1="27" y1="25" x2="27" y2="65" stroke="black" strokeWidth="1" transform="rotate(-15 27 45)"/>
                    <polygon points="50,70 45,55 55,55" fill="none" stroke="black" strokeWidth="2"/>
                    <rect x="45" y="20" width="12" height="35" fill="none" stroke="black" strokeWidth="2"/>
                    <path d="M35 75 Q40 85 50 80 Q60 85 65 75" fill="none" stroke="black" strokeWidth="2"/>
                </svg>
            )
        },
        {
            ...
            title: "Join communities. Connect with mentors. Grow together, not alone.",
            author: "HYRUP Team",
            icon: (
                <svg viewBox="0 0 100 100" className="w-full h-full">
                    <path d="M10 25 L10 75 L50 70 L50 20 Z" fill="none" stroke="black" strokeWidth="2"/>
                    <path d="M50 20 L50 70 L90 75 L90 25 Z" fill="none" stroke="black" strokeWidth="2"/>
                    <line x1="15" y1="30" x2="45" y2="28" stroke="black" strokeWidth="1"/>
                    <line x1="15" y1="38" x2="45" y2="36" stroke="black" strokeWidth="1"/>
    ...
    return (
        <div className='w-screen h-screen relative overflow-hidden bg-[#FFFAE9]'>
            ...
            {showReveal && (
                <PageReveal onComplete={() => setShowReveal(false)} />
            )}

            {/* Main Content */}
            <div className='absolute top-0 left-0 p-3 md:p-4 z-50'>
                <h1 className='text-xl md:text-2xl font-[inter-bold] text-amber-600'>HYRUP.IN</h1>
            </div>
            <div className='w-full h-full flex flex-col md:flex-row'>
                ...
                <div className='order-2 md:order-1 flex-1 flex flex-col items-start justify-center px-5 md:pl-10 py-6 md:py-0'>
                    ...
                    <div 
                        ...
                        onClick={handleClick}
                    >
                        <div className={`absolute w-full h-full transition-all duration-100 ease-out ${
                            isPressed 
                                ? 'top-0.5 left-0.5' 
                        ...
                        <div className={`relative flex items-center transition-transform duration-100 ease-out ${
                            isPressed ? 'translate-x-0.5 translate-y-0.5' : ''
                        }`}>
                            <div className={`absolute -left-7 md:-left-8 top-1/2 -translate-y-1/2 w-14 h-14 md:w-16 md:h-16 bg-[#D9F99D] rounded-full border-2 border-black flex items-center justify-center z-10 transition-all duration-100 ${
                            ...
                            <div className={`bg-[#D9F99D] rounded-lg border-2 border-black transition-all duration-100 ${
