        ...
        <div className="bg-[#FFFAE9] rounded-[10px] border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,0.5)] p-4">
          <div className="flex items-start relative justify-between gap-4">
            ...
            <button className="bg-[#D4F4A7] px-4 py-2 rounded-[10px] border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,0.5)] flex items-center justify-center gap-1 hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,0.5)] transition-all cursor-pointer">
              <span className="text-base font-[Jost-Bold] text-black">Resume</span>
          ...
          <div className="mt-4 flex items-center relative justify-between">
            ...
            <button className="bg-[#A8C5FF] absolute top-0 right-0 px-2 py-1 rounded-[10px] border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,0.5)] hover:translate-x-[4px] whitespace-nowrap hover:translate-y-[4px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,0.5)] transition-all cursor-pointer">
              <span className="text-[10px] font-[Jost-Bold] text-black">Edit Profile ✎</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="hidden md:flex md:gap-4">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="bg-[#FFFAE9] rounded-[10px] border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,0.5)] p-6 flex items-center justify-between">
            ...
            <button className="bg-[#A8C5FF] px-6 py-3 rounded-full border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,0.5)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,0.5)] transition-all cursor-pointer">
              <span className="text-[16px] font-[Jost-Bold] text-black">Edit Profile ✎</span>
            </button>
          </div>

          {/* About Section */}
          <div className="bg-[#FFFAE9] rounded-[10px] border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,0.5)] p-6">
            <h2 className="text-[20px] font-[Jost-Bold] text-black mb-3">About :</h2>
